...
Only one line added to the bottom of your .Rmd file is needed to add commenting functionality. Try it out with the [minimal example](minimal.html).
...
The minimal example and the hypothesis demo both use the [hypothesis client](https://github.com/hypothesis/client). By default comments are publicly stored but these demo pages don't yet contain a way to extract annotation contents directly.
